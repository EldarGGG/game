...
class Game:
    ...
    def create_forest_level(self):
        ...
        while trash_count < 8 and attempts < 150:
            # 5 обычного мусора + 3 речного = 8 для презентации
            if river_trash_count < 3 and blockage_segment:
    ...
    def create_city_level(self):
        ...
        trash_count = 0
        attempts = 0
        while trash_count < 10 and attempts < 150:
            x = random.randint(200, WORLD_WIDTH - 200)
            y = random.randint(200, WORLD_HEIGHT - 200)
    ...
    def create_desert_level(self):
        ...
        trash_count = 0
        attempts = 0
        while trash_count < 12 and attempts < 200:
            x = random.randint(200, WORLD_WIDTH - 200)
            y = random.randint(200, WORLD_HEIGHT - 200)
